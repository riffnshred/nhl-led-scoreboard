...
## Table of Contents
  ...
  - [Usage](#usage)
    ...
    - [Method 3 Using Crontab](#method-3-using-crontab)
...
Note that this only starts the scoreboard when the Pi boots up.  If the scoreboard crashes for whatever reason, it will
not automatically restart unless you reboot the Pi.  You can use either of the Supervisor or Terminal Multiplexer methods
mentioned earlier to manually restart the scoreboard if it crashes.
