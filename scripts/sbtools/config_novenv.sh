...
if (whiptail --title "New install?" --yesno "Is this a new install?" 8 78); then
    ...
    whiptail --msgbox  "To upgrade, run scripts/sbtools/sb-upgrade instead..." 25 80
    tput bold; echo "$(tput setaf 2)To upgrade, run scripts/sbtools/sb-upgrade instead...$(tput setaf 9)" ; tput sgr0
    exit
fi
