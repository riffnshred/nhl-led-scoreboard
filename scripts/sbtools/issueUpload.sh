...
echo `/usr/bin/neofetch --off --stdout | grep Host` >> /tmp/issue.txt
echo "------------------------------------------------------" >> /tmp/issue.txt
...
echo "------------------------------------------------------" >> /tmp/issue.txt
echo "${scoreboard_proc} stderr log, first 128kb" >> /tmp/issue.txt
echo "=================================" >> /tmp/issue.txt
/usr/local/bin/supervisorctl tail -128000 $scoreboard_proc stderr >> /tmp/issue.txt
echo "" >> /tmp/issue.txt
echo "------------------------------------------------------" >> /tmp/issue.txt
echo "${scoreboard_proc} stdout log, first 128kb" >> /tmp/issue.txt
echo "=================================" >> /tmp/issue.txt
/usr/local/bin/supervisorctl tail -128000 $scoreboard_proc >> /tmp/issue.txt
